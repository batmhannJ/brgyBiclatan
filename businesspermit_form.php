     ...
     ?> 
       ...
       <div class="col-xs-12 col-sm-6 col-md-8">
                ...
                background-repeat: no-repeat; background-position: center; background-size: 80%; background-color: rgba(255, 255, 255, 0.9); background-blend-mode: overlay; background-position: center top; height: 800px;">
                        ...
                        <p class="print-padding"  style="text-indent: 40px;text-align: justify;">Applied to operate a <b><u><?= $resident['bsname'];?></u></b> with business address at <b><u><?= $resident['houseno'];?> <?= $resident['street'];?>, Brgy. Biclatan, General Trias, Cavite</b></u>.</b></p>


                        <p class="print-padding" style="text-indent: 40px;text-align: justify;">This further certifies that the said business is not violating any of the provisions of RA 7160 and the Local Revenue Code of the Municipality of Biclatan, General Trias. That the said business will not adversely affect public order, health, condition, safety, convenience, comfort, interest and the general, welfare in the area.</p>
...
?>
                        <p class="print-padding" style="text-indent:40px;text-align: justify;">Given this <ins><?= date('jS');?></ins> day of <ins><?= date('F');?></ins>, 2024, here at Barangay Biclatan, General Trias, Cavite, Philippines, for whatever legal purpose it may serve.</p>
                        ...
                        <div style="display: flex;">
                            ...
                            <div style="flex: 1;"><br>
                                ...
                                <label style="margin-left:1em; margin-top: 10px;"><u>HON. IRENEO C. HATID</u></label><br>
